...
import 'package:ecommerce_shop/features/shop/models/cart_item_model.dart';
...
import 'package:ecommerce_shop/utils/local_storage/storage_utility.dart';
...
class CartController extends GetxController {
  ...
  void addToCart(ProductModel product) {
    ...
    // Convert ProductModel to CartItemModel with given quantity
    ...
    if (index >= 0) {
      // This quantity ios already added or updated/ from design
  ...
  void removeOneFromCart(CartItemModel item) {
    ...
    if (index >= 0) {
      if (cartItems[index].quantity > 1) {
        ...
        //show dialog box before complete removing
        cartItems[index].quantity == 1
