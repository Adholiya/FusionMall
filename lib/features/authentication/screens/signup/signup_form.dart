...
import 'package:ecommerce_shop/features/authentication/screens/signup/terms_conditions_checkbox.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      ...
      children: [
        ...
        const SizedBox(height: TSizes.spaceBtwSections,),
        //Sign Up Button
        SizedBox(width: double.infinity, child: ElevatedButton(onPressed: () => controller.signup(), child: const Text(TText.creteAccount)),)
      ],
    ));
  }
}
