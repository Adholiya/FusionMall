...
import 'package:ecommerce_shop/features/authentication/controller/signup/verify_email_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        //Padding to Give defualt equal space in all sides of screen
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                width: double.infinity,
                child: TextButton(
                    onPressed: () => controller.sendEmailVerification(), child: Text(TText.resendEmail)),
              ),
            ],
          ),
        ),
